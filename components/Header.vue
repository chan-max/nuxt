  ...
  <header class="bg-custom-900 text-white shadow-md">
    <div class="container mx-auto flex items-center justify-between py-4 px-6">
      ...
      <div class="flex items-center shrink-0">
        <img src="/logo.svg" alt="Logo" class="h-10 w-auto pr-2" />
      </div>

      <!-- 搜索框 -->
      <div class="flex-1 flex justify-center">
        <div
          class="hidden md:flex items-center bg-custom-800 hover:bg-custom-700 rounded-full overflow-hidden border-2 border-custom-500 focus-within:border-custom-600 transition"
        >
          <!-- 分类选择下拉框 -->
          <select
            v-model="searchType"
            @change="searchTypeChange"
            class="px-4 py-3 text-sm text-white bg-transparent border-none focus:outline-none sm:w-32 w-24 border-r-2 border-custom-400"
          >
          ...
          <input
            ...
            type="text"
            placeholder="Search..."
            class="px-4 py-3 text-sm text-white bg-transparent border-none focus:outline-none sm:w-64 w-48"
          />
    ...
    <div v-if="isMenuOpen" class="md:hidden bg-custom-800">
      ...
      <div class="mt-4 px-4 py-4">
        <div
          class="bg-custom-700 rounded-full overflow-hidden flex border-2 border-custom-500 focus-within:border-custom-600 transition"
        >
          <!-- 移动端的下拉框 -->
          <select
            v-model="searchType"
            class="px-4 py-3 text-sm text-white bg-transparent border-none focus:outline-none w-24"
          >
            <option value="title">Title</option>
            <option value="category">Category</option>
            <option value="tags">Tags</option>
          ...
          <input
            ...
            type="text"
            placeholder="Search..."
            class="px-4 py-3 text-sm text-white bg-transparent border-none focus:outline-none w-full"
          />
