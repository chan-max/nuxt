<template>
    <div v-if="visible" class="fixed inset-0 bg-black flex items-center justify-center z-50">
        <iframe :src="url" frameborder="0" class="w-full h-full" @load="handleLoad"></iframe>
        <div v-if="loading" class="absolute inset-0 bg-black opacity-75 flex items-center justify-center">
