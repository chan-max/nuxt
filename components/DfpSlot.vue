<template>
    <section class="ad-container">
        <div :id="adDivId" class="ad-slot flex items-center justify-center" v-show="showAd"></div>
    </section>
</template>
...
const defineAdSlot = () => {
    ...
    googletag.cmd.push(() => {
        switch (props.adType) {
            case 'anchor':
                adSlot = googletag.defineOutOfPageSlot(props.adUnitPath, googletag.enums.OutOfPageFormat.BOTTOM_ANCHOR);
                break;
            case 'interstitial':
                adSlot = googletag.defineOutOfPageSlot(props.adUnitPath, googletag.enums.OutOfPageFormat.INTERSTITIAL);
                break;
            case 'native':
                adSlot = googletag.defineSlot(props.adUnitPath, props.adSizes || 'fluid', adDivId.value);
                break;
            default:
